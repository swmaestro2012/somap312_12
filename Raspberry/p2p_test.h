...
#define NEGO_QUERY_INTERVAL 	0.5 * SEC //0.5
#define PRE_NEGO_INTERVAL 		0.5 * SEC //0.5
...
#define SUPPLICANT_INIT_TIME	1 * SEC
#define HOSTAPD_INIT_TIME		5 * SEC
//#define SUPPLICANT_INTERVAL		1 * SEC
#define SUPPLICANT_INTERVAL		1 * SEC //1
#define HOSTAPD_INTERVAL 		1 * SEC //1
#define POLLING_INTERVAL		1 * SEC //1
#define _TRUE 1
#define _FALSE 0
